  ...
  const config = {
    ...
    plugins: [
      new webpack.DefinePlugin({
        ...
        'process.env.OIDC_REDIRECT_MEDICAL_VIEW_URI': JSON.stringify(
          process.env.OIDC_REDIRECT_MEDICAL_VIEW_URI || ''
        ),
        'process.env.MEDICAL_VIEW_URL_PREFIX': JSON.stringify(
          process.env.MEDICAL_VIEW_URL_PREFIX || ''
        ),
        ...
        'process.env.OIDC_ACCESS_TOKEN_URI': JSON.stringify(
          process.env.OIDC_ACCESS_TOKEN_URI || ''
        ),
        'process.env.OIDC_AUTHORIZATION_URI': JSON.stringify(
          process.env.OIDC_AUTHORIZATION_URI || ''
        ),
        'process.env.OIDC_LOGOUT_URI': JSON.stringify(
          process.env.OIDC_LOGOUT_URI || ''
        ),
        'process.env.OIDC_USERINFO_ENDPOINT': JSON.stringify(
          process.env.OIDC_USERINFO_ENDPOINT || ''
        ),
        'process.env.OIDC_REDIRECT_URI': JSON.stringify(
          process.env.OIDC_REDIRECT_URI || ''
        ),
        'process.env.OIDC_SCOPE': JSON.stringify(process.env.OIDC_SCOPE || ''),
        'process.env.OIDC_AUDIENCE': JSON.stringify(
