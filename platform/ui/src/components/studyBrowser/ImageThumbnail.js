...
export default React.memo(ImageThumbnail, (preProps, nextProps) => {
  return (
    preProps.imageId === nextProps.imageId &&
    preProps.imageSrc === nextProps.imageSrc &&
    preProps.error === nextProps.error &&
    preProps.stackPercentComplete === nextProps.stackPercentComplete &&
    preProps.width === nextProps.width &&
    preProps.height === nextProps.height
  );
});
