...
const publicAPI = {
  ...
  create: _create,
  updateLastPosition: _updateLastPosition,
...
const serviceImplementation = {
  ...
  _updateLastPosition: () =>
    console.warn('_updateLastPosition() NOT IMPLEMENTED'),
};
...
function _updateLastPosition(position = {}) {
  return serviceImplementation._updateLastPosition(position);
}
...
function setServiceImplementation({
  ...
  dismissAll: dismissAllImplementation,
  create: createImplementation,
  updateLastPosition: updateLastPositionImplementation,
}) {
  ...
  if (updateLastPositionImplementation) {
    serviceImplementation._updateLastPosition = updateLastPositionImplementation;
  }
}
